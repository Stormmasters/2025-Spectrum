...
public class TagProperties {
     ...
     * @param angle
     */
    public TagProperties(double offsetInchesLeft, double offsetInchesRight, double centerOffsetInchesLeft, double centerOffsetInchesRight, double taGoal, double angleDegrees) {
